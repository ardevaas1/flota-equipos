...
function iconoEquipo(tipo) {
  ...
  const svgs = {
    ...
    excavadora: `<svg viewBox="0 0 24 24" fill="none" class="equipo-svg"><path d="M1.5 19.7h13.3l1.7-2.8H3Z" fill="white"/><rect x="4.7" y="10.7" width="7" height="6.2" rx="1.3" stroke="white" stroke-width="2.1"/><path d="M9.7 12.2h4l6-7" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M19.3 3.6 22.7 5.5 20.7 9.3 17.3 7.4Z" fill="white"/></svg>`,
    ...
    grua: `<svg viewBox="0 0 24 24" fill="none" class="equipo-svg"><circle cx="4.7" cy="19.7" r="2" fill="white"/><circle cx="9" cy="19.7" r="2" fill="white"/><rect x="2" y="15" width="9" height="5" rx="1.2" stroke="white" stroke-width="2"/><path d="M5.5 15 19.7 3" stroke="white" stroke-width="2.2" stroke-linecap="round"/><circle cx="19.7" cy="9.5" r="2" fill="white"/></svg>`,
    ...
    mixer: `<svg viewBox="0 0 24 24" fill="none" class="equipo-svg"><circle cx="5" cy="19" r="2" fill="white"/><circle cx="18.3" cy="19" r="2.3" fill="white"/><rect x="2" y="13.7" width="6" height="5.3" rx="1.2" stroke="white" stroke-width="2"/><ellipse cx="15.5" cy="10" rx="6.7" ry="4" transform="rotate(-20 15.5 10)" fill="white"/><path d="M8 15.7h13.3" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>`,
    tractor: `<svg viewBox="0 0 24 24" fill="none" class="equipo-svg"><circle cx="6.3" cy="18.3" r="3.5" fill="white"/><circle cx="17.7" cy="18.3" r="2.2" fill="white"/><rect x="3" y="10" width="7" height="5.3" rx="1.2" stroke="white" stroke-width="2.1"/><path d="M10 12.3h6.7v4.3" stroke="white" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"/><path d="M5.3 10v-3.7h1.7" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>`,
