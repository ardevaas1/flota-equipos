...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzfmF5VyA0qLCvagViCb9l3N_d89UgHObTqnFyCSKEkA4IQ6xL6kMRtCrb9eaX7vJQ7Sw/exec';
...
function iconoEquipo(tipo) {
  ...
  const svgs = {
    ...
    minicargador: `<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="equipo-svg"><circle cx="7" cy="17" r="2.3"/><circle cx="13" cy="17" r="2.3"/><path d="M4.5 14.5v-4.5h9v4.5"/><path d="M13.5 10.5l5 1v5.5l-3 1.2"/><path d="M18.5 15h2.5l1 -3.3"/></svg>`,
    manipulador: `<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="equipo-svg"><circle cx="6" cy="17.5" r="2.2"/><circle cx="11.3" cy="17.5" r="2.2"/><path d="M3.3 15v-4.5h9v4.5"/><path d="M9.3 11 20.5 3.3"/><path d="M20.5 3.3v2.7"/><path d="M18 4.6l2.5 1.4"/></svg>`,
    grua: `<svg viewBox="0 0 24 24" fill="none" class="equipo-svg"><path d="M20,6V5A1,1 0 0,0 19,4H9V3H6V4H5V6H6V15H5V13H3V15H2V17H3V21H5V17H10V21H12V19.92L12,17H13V15H12V13H10V15H9V6H17V10.62C16.53,10.79 16.19,11.23 16.19,11.76C16.19,12.2 16.43,12.6 16.8,12.82V14H17.42C17.76,14 18.03,14.28 18.03,14.62C18.03,14.96 17.76,15.24 17.42,15.24C17.2,15.24 17,15.12 16.89,14.93C16.71,14.64 16.34,14.54 16.05,14.71C15.75,14.87 15.65,15.25 15.82,15.55C16.15,16.11 16.76,16.47 17.42,16.47C18.43,16.47 19.26,15.64 19.26,14.62C19.26,13.84 18.76,13.14 18.03,12.88V12.82C18.41,12.6 18.65,12.2 18.65,11.76C18.65,11.3 18.38,10.91 18,10.7V6H20M8,13.66L7,14.66V13.24L8,12.24V13.66M8,10.71L7,11.71V10.29L8,9.29V10.71M7,8.71V7.29L8,6.29V7.71L7,8.71Z" fill="white"/></svg>`,
    rodillo: `<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="equipo-svg"><circle cx="6" cy="17" r="3"/><circle cx="18" cy="17" r="3"/><path d="M6 14v-5a1 1 0 0 1 1 -1h10a1 1 0 0 1 1 1v5"/></svg>`,
    mixer: `<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="equipo-svg"><circle cx="5.3" cy="18" r="1.9"/><circle cx="18.5" cy="18" r="2.1"/><circle cx="22.5" cy="18" r="2.1"/><path d="M3 16v-4.7h6v4.7"/><path d="M9 12.7h2.7"/><path d="M9.7 15.8 21.5 12l3 1.3v4.7"/><path d="M8.7 16h16.3"/><path d="M11 11.7l9 3.6"/></svg>`,
    tractor: `<svg viewBox="0 0 24 24" fill="none" class="equipo-svg"><path d="M5,4V11.26C3.2,11.9 2,13.6 2,15.5C2,18 4,20 6.5,20C8.79,20 10.71,18.28 10.97,16H15.17C15.06,16.32 15,16.66 15,17A3,3 0 0,0 18,20A3,3 0 0,0 21,17C21,16.66 20.94,16.32 20.82,16H22V13C22,11.89 21.11,11 20,11H15.04L13.65,4H5M7,6H12L13,11V14H10.74C10.16,12.38 8.71,11.23 7,11.03V6M6.5,13.25A2.25,2.25 0 0,1 8.75,15.5A2.25,2.25 0 0,1 6.5,17.75A2.25,2.25 0 0,1 4.25,15.5A2.25,2.25 0 0,1 6.5,13.25M18,15.5A1.5,1.5 0 0,1 19.5,17A1.5,1.5 0 0,1 18,18.5A1.5,1.5 0 0,1 16.5,17A1.5,1.5 0 0,1 18,15.5Z" fill="white"/></svg>`,
    generador: `<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="equipo-svg"><rect x="2" y="7" width="18" height="10" rx="1.5"/><path d="M5 10.5h6M5 12.7h6M5 14.9h6"/><rect x="14" y="9.5" width="4" height="5" rx="0.5"/><path d="M2 19h18M5 7V5M17 7V5"/></svg>`,
